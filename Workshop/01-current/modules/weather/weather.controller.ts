...
export class WeatherController {
  ...
  @ApiResponse({ status: 200, description: 'Returns the weather for the given zip code.', type: () => WeatherDto })
  @ApiResponse({ status: 404, description: 'Weather data not found', type: () => Error })
  @Get(':zipCode')
  async getWeather(@Param('zipCode') zipCode: string): Promise<WeatherDto | HttpStatus> {
